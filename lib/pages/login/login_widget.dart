              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: Image.asset(
                      'assets/images/DALLE_2024-09-29_11.52.33_-_A_high-quality_mobile_app_background_for_a_brand_named_Nagaad_Coffee_&_Wedding_Halls._The_design_should_be_modern,_elegant,_and_visually_appealing._.webp',
                    ).image,
                  ),
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.apiResultmdq =
                                  await OdooAuthenticationCall.call(
                                user: _model.txtusernameTextController.text,
                                pass: _model.txtpasswordTextController.text,
                              );
                              ...
                              if (getJsonField(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      '( ${_model.txtusernameTextController.text} )  is not registered in our records',
                                      style: TextStyle(
                                        color:
